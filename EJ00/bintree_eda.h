...
//  bintree_eda.h
//
//  ImplementaciÛn de ·rboles binarios (con comparticiÛn de nodos)
//
...
protected:
    /*
     ...
     nullptr si el hijo es vacÌo (no existe).
     */
    struct TreeNode;
...
public:
    ...
    // constructora por copia, operador de asignaciÛn y destructora por defecto
    
    // consultar si el ·rbol est· vacÌo
    bool empty() const {
        return raiz == nullptr;
    }
